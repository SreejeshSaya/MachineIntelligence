...
def test_case():
    ...
    print('Airtemp entropy : ',get_entropy_of_attribute(df, 'Airtemp')==0.6490224995673063) #0.6490224995673063
    print('Airtemp IG : ', get_information_gain(df, 'Airtemp')==0.3219280948873623) #0.3219280948873623
    print('Humidity entropy : ',get_entropy_of_attribute(df, 'Humidity')==0.9509775004326937) #0.9509775004326937
    print('Humidity IG : ', get_information_gain(df, 'Humidity')==0.01997309402197489) #0.01997309402197489
    print('Water entropy : ',get_entropy_of_attribute(df, 'Water')==0.8) #0.8
    ...
    print('Income entropy : ', get_entropy_of_attribute(df, 'Income')==0.9110633930116763) #0.9110633930116763
    print('Income IG : ', get_information_gain(df, 'Income')==0.02922256565895487) #0.02922256565895487
    print('Student entropy : ', get_entropy_of_attribute(df, 'Student')==0.7884504573082896) #0.7884504573082896
    ...
    print('Breathes entropy : ', get_entropy_of_attribute(df,'breathes')==0.8264662506490407) #0.8264662506490407
    print('Breathes IG : ', get_information_gain(df,'breathes')==0.1444843438056279) #0.1444843438056279
    print('Legs entropy : ', get_entropy_of_attribute(df,'legs')==0.4141709450076292) #0.4141709450076292
